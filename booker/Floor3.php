...
<body>
    <main>
        <div class="layout">
            ...
            <div class="room large" id="SC2-307">
                <span onclick="window.location.href='Schedule.php'" style="cursor: pointer; text-decoration: underline; color: inherit;">SC2-307</span>
            </div>
            <div class="room large sc2-308" id="SC2-308">
                <span onclick="window.location.href='Schedule.php'" style="cursor: pointer; text-decoration: underline; color: inherit;">SC2-308</span>
            </div>            
